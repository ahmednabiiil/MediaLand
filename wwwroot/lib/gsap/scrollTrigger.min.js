...
!(function (e, r) {
   ...
   function P(e) {
      return (
         ...
         (M(e)
            ? function () {
                 return (
                    (wr.width = ze.innerWidth), (wr.height = ze.innerHeight), wr
                 );
              }
            : function () {
                 return hr(e);
      ...
      if (o) {
         ...
         (d = "scroll" + n.d2),
            E(
               ...
               (T && 20 < w) ||
                  (!T &&
                     (u ? Math.max(Fe[d], We[d]) : o.parentNode[d]) <= w + 1)
            ),
            u &&
               ((l = hr(a)),
      ...
      Sr = function _setState(e) {
         if (e) {
            var r,
               ...
               o = 0;
            for (
               (e.t._gsap || Re.core.getCache(e.t)).uncache = 1;
               o < i;
               o += 2
            )
               (t = e[o + 1]),
                  ...
                  t
                     ? (n[r] = t)
                     : n[r] &&
                       n.removeProperty(r.replace(U, "-$1").toLowerCase());
         }
      },
      wr = { left: 0, top: 0 },
   ...
   var ee =
      ((ScrollTrigger.prototype.init = function init(E, k) {
         if (
            ((this.progress = this.start = 0), this.vars && this.kill(1), er)
         ) {
            var m,
               n,
               f,
               ...
               ae,
               se = (E = wa(
                  rr(E) || W(E) || E.nodeType ? { trigger: E } : E,
                  mr
               )).onUpdate,
               le = E.toggleClass,
               o = E.id,
            ...
            if (
               ...
               de &&
                  (!1 === ge ||
                     ge === ur ||
                     (ge =
                        !(!ge && "flex" === ua(de.parentNode).display) && cr),
                  (Ie.pin = de),
            ...
            (Ie.previous = function () {
                        ...
                        (r
                           ? (function _swapPinOut(e, r, t) {
                                ...
                                if (n.spacerIsNative) Sr(n.spacerState);
                                   ...
                                   var i = r.parentNode;
                                   i &&
                                      (i.insertBefore(e, r), i.removeChild(r));
                                }
                             })(de, Q, J)
                  ...
                  if ((!Xe && Ie.enabled) || r)
                     if (de && e && Ge) Ea(ScrollTrigger, "scrollEnd", Xa);
                        ...
                        f &&
                           ...
                           de &&
                              ge &&
                              (Q._pinOffset = Math.round(Ie.progress * Z)),
                           ue && ue(Ie);
                     }
               }),
               ...
               (Ie.update = function (e, r, t) {
                  if (!ye || t || e) {
                     ...
                     if (w) {
                        var v = ye
                           ? (u / ye.duration()) * (ye._caScrollDist || 0)
                           : u;
