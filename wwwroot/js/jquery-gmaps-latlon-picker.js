...
$.fn.gMapsLatLonPicker = (function() {
	...
	var setPosition = function(position) {
        ...
        $(_self.vars.cssID + ".gllLatLng").val(position.lat() + "," + position.lng());
	...
	var publicfunc = {
		...
		init : function(object) {
		    ...
		    //_self.params.defLat = $(_self.vars.cssID + ".gllLatLng").val() ? $(_self.vars.cssID + ".gllpLatitude").val() : _self.params.defLat;
		    //_self.params.defLng = $(_self.vars.cssID + ".gllpLongitude").val() ? $(_self.vars.cssID + ".gllpLongitude").val() : _self.params.defLng;
            _self.params.defLat = $(_self.vars.cssID + ".gllLatLng").val() ? $(_self.vars.cssID + ".gllLatLng").val().split(',',2)[0] : _self.params.defLat;
            _self.params.defLng = $(_self.vars.cssID + ".gllLatLng").val() ? $(_self.vars.cssID + ".gllLatLng").val().split(',', 2)[1] : _self.params.defLng;
			...
			$(_self.vars.cssID + ".gllpUpdateButton").bind("click", function() {
                ...
                var lat = $(_self.vars.cssID + ".gllLatLng").val().split(',', 2)[0];
                var lng = $(_self.vars.cssID + ".gllLatLng").val().split(',', 2)[1];
