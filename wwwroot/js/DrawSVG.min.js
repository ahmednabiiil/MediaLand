...
!(function (e, t) {
   ...
   function C() {
      i() &&
         ...
         (h = a = j()),
         (v = a.utils.toArray),
         (l = -1 !== ((d.navigator || {}).userAgent || "").indexOf("Edge")));
   }
   var a,
      v,
      d,
      ...
      g = {
         ...
         init: function init(e, i) {
            ...
            return (
               ...
               l &&
                  (a = d.getComputedStyle(e)).strokeLinecap !==
                     a.strokeLinejoin &&
                  ((s = n(a.strokeMiterlimit)),
                  this.add(e.style, "strokeMiterlimit", s, s + 0.01)),
               (this._live = t(e) || ~(i + "").indexOf("live")),
         ...
         render: function render(e, t) {
            ...
            if (s) {
               ...
               (r = t._dash || (e && 1 !== e && 1e-4) || 0),
                  ...
                  r &&
                     o &&
                     r + Math.abs(o % t._length) > t._length - 0.2 &&
                     (o += o < 0 ? 0.1 : -0.1) &&
                     (n += 0.1),
